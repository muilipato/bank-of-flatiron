...
First click on this link to start the json server before starting the app [server](https://bank-data.onrender.com/){:target ="_blank"}

To start the app click [Bank-of-flatiron](https://muilipato.github.io/bank-of-flatiron/){:target="_blank"}
